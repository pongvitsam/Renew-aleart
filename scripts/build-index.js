...
const html = [
  ...
  testModal,
  departmentModal,
  '<script src="/Renew-aleart/assets/js/config.js?v=8"></script>',
  '<script src="/Renew-aleart/assets/js/app-cache.js?v=8"></script>',
  '<script src="/Renew-aleart/assets/js/api.js?v=8"></script>',
  '<script src="/Renew-aleart/assets/js/utils.js?v=8"></script>',
  '<script src="/Renew-aleart/assets/js/app-index.js?v=8"></script>',
  '<script src="/Renew-aleart/assets/js/app-state.js?v=8"></script>',
  '<script src="/Renew-aleart/assets/js/app-departments.js?v=8"></script>',
  '<script src="/Renew-aleart/assets/js/app-sidebar.js?v=8"></script>',
  '<script src="/Renew-aleart/assets/js/app-calendar.js?v=8"></script>',
  '<script src="/Renew-aleart/assets/js/app-timeline.js?v=8"></script>',
  '<script src="/Renew-aleart/assets/js/app-dashboard.js?v=8"></script>',
  '<script src="/Renew-aleart/assets/js/app-project.js?v=8"></script>',
  '<script src="/Renew-aleart/assets/js/app-modals.js?v=8"></script>',
  '<script src="/Renew-aleart/assets/js/app-main.js?v=8"></script>',
  '</body></html>'
].join('');
